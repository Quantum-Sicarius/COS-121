...
ListAsVector::ListAsVector() { this->theList = new std::vector<Object *>(); }

ListAsVector::~ListAsVector() { delete[] this->theList; }

void ListAsVector::insert(Object *&o) { this->theList->push_back(o); }
...
Object &ListAsVector::operator[](int i) { return *this->theList->at(i); }
