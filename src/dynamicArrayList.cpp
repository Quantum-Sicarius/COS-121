...
DynamicArrayList::~DynamicArrayList() { delete[] this->theList; }
...
int DynamicArrayList::size() { return this->listSize; }
...
int DynamicArrayList::compareTo(Object const &) const { return 0; }
